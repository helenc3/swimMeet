...
COURSE_HANDLER_DIR = Path(__file__).resolve().parent
TEAMCOURSES_FILE = COURSE_HANDLER_DIR / "teamcourses.json"
UNIQUE_TEAMS_FILE = COURSE_HANDLER_DIR / "uniqueteams.txt"
SWIMMER_TEAMS_FILE = COURSE_HANDLER_DIR / "swimmer_teams.txt"
...
def print_unique_teams_for_all_swimmers(collection, filename=UNIQUE_TEAMS_FILE):
    ## this is js for testing purposes only
    """
...
def save_unique_teams_per_swimmer_to_file(collection, filename=SWIMMER_TEAMS_FILE):
    ## this is js for testing purposes only
    """
