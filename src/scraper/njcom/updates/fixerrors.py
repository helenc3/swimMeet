...
from scraper.njcom.updates.utils import ERRORS_PATH, save_meet_data_to_mongodb
from common.utils import parse_time_to_seconds, OFFICIAL_COLLECTION_NAME, convert_time_to_scy
from common.mongodb.connect import connect_to_mongodb
import csv
import os

"""
this script is used to fix errors in the error csv files.
- reads error csv files from the ERRORS_PATH folder.
- parses the data and converts the times to SCY seconds.
- saves the data to the mongodb database.
- deletes the error csv files after processing.
- ONLY RUN THIS SCRIPT AFTER YOU HAVE REVIEWED THE ERROR CSV FILES AND CONFIRMED THE CORRECT TIMES.
"""
